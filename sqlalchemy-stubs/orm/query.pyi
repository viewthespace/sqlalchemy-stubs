...
class Query(object, Generic[_T]):
    session: Any = ...
    def __init__(self, entities: List[_T], session: Optional[Any] = ...) -> None: ...
    @property
    def statement(self): ...
    ...
    def autoflush(self, setting: bool): ...
    ...
    def value(self, column) -> Iterator[Any]: ...
    def with_entities(self, *entities): ...
    def add_columns(self, *column) -> Query[_T]: ...
    def add_column(self, column) -> Query[_T]: ...
    ...
    def filter_by(self, **kwargs) -> Query[_T]: ...
    def order_by(self, *criterion) -> Query[_T]: ...
    def group_by(self, *criterion) -> Query[_T]: ...
    def having(self, criterion) -> Query[_T]: ...
    def union(self, *q): ...
    ...
    def slice(self, start, stop) -> Query[_T]: ...
    def limit(self, limit) -> Query[_T]: ...
    def offset(self, offset) -> Query[_T]: ...
    def distinct(self, *criterion) -> Query[_T]: ...
    ...
    def update(self, values, synchronize_session: str = ..., update_args: Optional[Any] = ...) -> int: ...
